...
class ContextPolicy:
    ...
    task_max_chars: int = 12_000
    task_max_tokens: int = 3_000
...
class ContextAssembler:
    ...
    def _evidence_component_limit(self, name: str, fallback: int) -> int:
        limits = {
            ...
            "task": self.policy.task_max_chars,
            "loaded_state": self.policy.task_max_chars,
    ...
    def _evidence_component_token_limit(self, name: str) -> int | None:
        limits = {
            ...
            "task": self.policy.task_max_tokens,
            "loaded_state": self.policy.task_max_tokens,
    ...
    def _shrink_evidence_component(self, name: str, value: Any, *, max_chars: int) -> Any:
        ...
        if name == "current_subagents" and isinstance(value, Mapping):
            return self._bounded_mapping_projection(
                value,
                keys=("available", "count", "truncated", "status_semantics", "agents"),
                max_chars=max_chars,
            )
